...
public class ConstituencyTree_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("it.unitn.limosine.types.syntax.ConstituencyTree");
  ...
  public String getRawParse(int addr) {
      ...
      jcas.throwFeatMissing("rawParse", "it.unitn.limosine.types.syntax.ConstituencyTree");
  ...
  public String getAnnotatorId(int addr) {
      ...
      jcas.throwFeatMissing("annotatorId", "it.unitn.limosine.types.syntax.ConstituencyTree");
  ...
  public int getSentence(int addr) {
      ...
      jcas.throwFeatMissing("sentence", "it.unitn.limosine.types.syntax.ConstituencyTree");
